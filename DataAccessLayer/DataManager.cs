...
public class DataManager
{
    ...
    public DataManager()
    {
        ...
        //var dataBaseName = ConfigurationManager.AppSettings["LPCFacturas"];
        //var string_conexion = ConfigurationManager.ConnectionStrings[LPCFacturas].ConnectionString;
        //var dataBaseName = System.Configuration.ApplicationSettingsBase["LPCFacturas"];
        //var string_conexion = System.Configuration;
        ...
        //dbConnection.ConnectionString = @"\\Data Source=MIPC\SQLEXPRESS\SQLEXPRESS;Initial Catalog=BugsExtendido;User ID=a;Password=a";
        dbConnection.ConnectionString = @"Data Source = MIPC\SQLEXPRESS; Initial Catalog = LPCFacturas; Integrated Security = True";
        
       // dbConnection.ConnectionString = @"Data Source=MIPC\SQLEXPRESS\LPCFacturas;Initial Catalog=BugsExtendido;User ID=administrador;Password=12345";
        ...
        //dbConnection.ConnectionString = @"Data Source=200.69.137.167,11333;Initial Catalog=PAV-3K2-2021-6;User ID=PAV_3K2_2021_6;Password=PAV_3K2_2021_6";
